...
import { getBrowserLocation } from "../../controllers/locationController.js";

const LocationGPSButton = () => {
  ...
  return (
    <div onClick={onClick} className={loading ? "gps-button-container gps-button-container-loading" : "gps-button-container"}>
...
export default LocationGPSButton;
