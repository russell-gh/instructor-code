...
class Terms extends Component {
  render() {
    return (
      <div className="terms">
        Preview your Terms & Conditions Terms and Conditions Welcome to
        magpiewatchrental.uk! These terms and conditions outline the rules and
        regulations for the use of MWR's Website, located at
        magpiewatchrental.uk. By accessing this website we assume you accept
        these terms and conditions. Do not continue to use magpiewatchrental.uk
        ...
        with and subject to, prevailing law of af. Any use of the above
        terminology or other words in the singular, plural, capitalization
        and/or he/she or they, are taken as interchangeable and therefore as
        referring to same. Cookies We employ the use of cookies. By accessing
        magpiewatchrental.uk, you agreed to use cookies in agreement with the
        MWR's Privacy Policy. Most interactive websites use cookies to let us
        ...
        partners may also use cookies. License Unless otherwise stated, MWR
        and/or its licensors own the intellectual property rights for all
        material on magpiewatchrental.uk. All intellectual property rights are
        reserved. You may access this from magpiewatchrental.uk for your own
        personal use subjected to restrictions set in these terms and
        conditions. You must not: Republish material from magpiewatchrental.uk
        Sell, rent or sub-license material from magpiewatchrental.uk Reproduce,
        duplicate or copy material from magpiewatchrental.uk Redistribute
        content from magpiewatchrental.uk This Agreement shall begin on the date
        hereof. Our Terms and Conditions were created with the help of the Free
        Terms and Conditions Generator. Parts of this website offer an
        opportunity for users to post and exchange opinions and information in
        certain areas of the website. MWR does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of MWR,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, MWR
        ...
        of and/or appearance of the Comments on this website. MWR reserves the
        right to monitor all Comments and to remove any Comments which can be
        considered inappropriate, offensive or causes breach of these Terms and
        Conditions. You warrant and represent that: You are entitled to post the
        Comments on our website and have all necessary licenses and consents to
        do so; The Comments do not invade any intellectual property right,
        ...
        MWR a non-exclusive license to use, reproduce, edit and authorize others
        ...
        these organizations if we decide that: (a) the link would not make us
        look unfavorably to ourselves or to our accredited businesses; (b) the
        organization does not have any negative records with us; (c) the benefit
        to us from the visibility of the hyperlink compensates the absence of
        MWR; and (d) the link is in the context of general resource information.
        ...
        e-mail to MWR. Please include your name, your organization name, contact
        ...
        the linking party's site. No use of MWR's logo or other artwork will be
        allowed for linking absent a trademark license agreement. iFrames
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website. Content Liability We shall not be hold
        responsible for any content that appears on your Website. You agree to
        protect and defend us against all claims that is rising on your Website.
        No link(s) should appear on any Website that may be interpreted as
        ...
        be bound to and follow these linking terms and conditions. Removal of
